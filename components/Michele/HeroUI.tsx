...
export const HeroUI = ({
  ...
  return (
    <div className="absolute h-full w-full inset-0 z-10 flex justify-between flex-col">
      ...
      /> */}
      <div className="flex flex-row py-6 bg-neutral-100 items-center gap-10 pr-8 rounded-l-3xl rounded-r-full bottom-20 shadow-lg shadow-black/40 max-w-xl mx-auto absolute pl-6 text-start">
        <div>
